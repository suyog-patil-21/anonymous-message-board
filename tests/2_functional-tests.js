...
suite('Functional Tests', function () {
    ...
    test('Viewing the 10 most recent threads with 3 replies each: GET request to /api/threads/{board}', async function () {
        ...
        chai.expect(response.body).to.have.lengthOf.at.most(10);
        ...
        chai.expect(response.body[0]['replies']).to.have.lengthOf.at.most(3);
        ...
        // TODO : check the api when replies is added working or not
    });
